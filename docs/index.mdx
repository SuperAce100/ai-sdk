...
<Card title="Quick Start" icon="zap" href="/sdk/introduction" horizontal>
...
<CardGroup cols={2}>
<Card title="Basic Text" href="/examples/basic-text" icon="message-square">
...
<Card title="Structured Output" href="/examples/structured-output" icon="package">
  Working with Pydantic models.
</Card>

<Card title="Tool Agent" href="/examples/tool-agent" icon="bot">
...
<Card title="PyPI" href="https://pypi.org/project/ai-sdk-python/" icon="package">
  Install the package from PyPI.
</Card>

<Card title="Support" href="mailto:asanshay@bharatgupta.com" icon="mail">
